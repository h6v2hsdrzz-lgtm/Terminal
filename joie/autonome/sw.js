/**
 * Service worker du Journal de joie.
 *
 ...
 *  - la page elle-même part sur le réseau d'abord, pour qu'une mise à jour
 *    arrive dès qu'elle existe, avec la copie en cache comme filet ;
