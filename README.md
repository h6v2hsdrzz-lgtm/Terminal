...
pronostic/              hors-sujet assumé : moteur de prédiction des dernières
                        affiches de la Coupe du monde 2026 (Elo vivant,
                        Dixon-Coles, Monte-Carlo minute par minute, évaluateur
                        de combinés) — voir pronostic/README.md
```
